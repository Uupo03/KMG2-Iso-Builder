...
echo \======================================================/
SET /P moddedFile=Please enter a name. (e.g. Kaizo Mario Galaxy 2.iso, Kaizo Mario Galaxy 2.wbfs): 
...
echo \==================================/
SET /P  newGameID=Please enter the new Game ID (e.g. KAIZ02): 
...
echo \==============================/
SET /P  newTMD=Please enter the new TMD (e.g. KAI2): 
